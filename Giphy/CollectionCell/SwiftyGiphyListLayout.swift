...
public protocol SwiftyGiphyListLayoutDelegate: AnyObject {

    func collectionViewList(collectionView:UICollectionView, heightForPhotoAtIndexPath indexPath: IndexPath, withWidth: CGFloat) -> CGFloat
}

public class SwiftyGiphyListLayout: UICollectionViewLayout {

    weak var delegate: SwiftyGiphyListLayoutDelegate?
    ...
    var preferredCellWidth: CGFloat = 100.0 {
        didSet {
            invalidateLayout()
        }
    }
    ...
    override public func prepare() {
        ...
        if cellAttributeCache.isEmpty
        {
            ...
            for item in 0..<collectionView!.numberOfItems(inSection: 0)
            {
                ...
                guard let cellHeight = delegate?.collectionViewList(collectionView: collectionView!, heightForPhotoAtIndexPath: indexPath, withWidth: columnWidth) else {
                    continue
                }
...
//
//        contentHeight = 0.0
//        cellAttributeCache = [DisplaySwitchLayoutAttributes]()
//    }
